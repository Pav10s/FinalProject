...
public class Chrome extends AppCompatActivity {
    ...
    String[] google_search_strings = {"Blah","Blah","Blah","Blah","Blah","Blah"};

    String[] google_search = {"https://firebasestorage.googleapis.com/v0/b/final-project-b573c.appspot.com/o/Google%2FChrome%2FSearch%2FVID-20230308-WA0028.gif?alt=media&token=d469b257-c69a-4378-a933-75b7619a366d",
    ...
    String[] redmi_search_strings = {"Blah","Blah","Blah","Blah","Blah","Blah"};

    String[] redmi_search = {"https://firebasestorage.googleapis.com/v0/b/final-project-b573c.appspot.com/o/Redmi%2FChrome%2FchromeSearch%2Fc1.gif?alt=media&token=1bce288a-63f4-40f9-a280-eebc7624ed5e",
