...
public class Gmail extends AppCompatActivity {
    ...
    private String[] redmi_send_mail_strings = {"Blah", "Blah", "Blah", "Blah", "Blah", "Blah"};
    ...
    private String[] google_send_mail_strings = {"Blah", "Blah", "Blah", "Blah", "Blah", "Blah"};
    ...
    private String[] redmi_attach_to_mail_strings = {"Blah", "Blah", "Blah", "Blah", "Blah", "Blah"};
    ...
    private String[] google_attach_to_mail_strings = {"Blah", "Blah", "Blah", "Blah", "Blah", "Blah"};
