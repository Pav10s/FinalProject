...
public class MainActivity extends AppCompatActivity implements RecyclerViewInterface {
    ...
    int[] recImages = {R.drawable.phone,R.drawable.comment,
            R.drawable.camera,R.drawable.whatsapp,
            R.drawable.chrome,R.drawable.youtube,
            R.drawable.voice,R.drawable.playstore,
            R.drawable.gmail};
    ...
    public void onItemClick(int position) {
            ...
            if (position == 0)
                ...
                startActivity(new Intent(this, VoiceRecorder.class));
            else if (position == 7)
